...
public class fourSampleSensedTransfer extends atlantisAutoEssentials {
    ...
    public void runOpMode() {
        ...
        Action block2 = drive.actionBuilder(dropPose)
                ...
                //transfer
                .afterTime(0, new SequentialAction(transferSensed(1), new SleepAction(0.2), transferSensed(2), closeDeposit(), new SleepAction(0.1), openIntake(), intakeTransferAction(intakeTransferIn + 0.3), moveSlideHighBasket()))
                //drop block
                .strafeToLinearHeading(dropVector, dropAngle)
