...
import org.firstinspires.ftc.teamcode.rrfiles.messages.PoseMessage;
...
public class SparkFunOTOSDrive extends MecanumDrive {
    public static class Params {
        ...
        // robot. The units default to inchesToBlock and degrees, but if you want to use
        // different units, specify them before setting the offset! Note that as of
        // firmware version 1.0, these values will be lost after a power cycle, so
        // you will need to set them each time you power up the sensor. For example, if
        // the sensor is mounted 5 inchesToBlock to the left (negative X) and 10 inchesToBlock
        // forward (positive Y) of the center of the robot, and mounted 90 degrees
        // clockwise (negative rotation) from the robot's orientation, the offset
        // would be {-5, 10, -90}. These can be any value, even the angle can be
        // tweaked slightly to compensate for imperfect mounting (eg. 1.3 degrees).

        // RR localizer note: These units are inchesToBlock and radians.
        ...
        // inverse of the error. For example, if you move the robot 100 inchesToBlock and
        // the sensor reports 103 inchesToBlock, set the linear scalar to 100/103 = 0.971
