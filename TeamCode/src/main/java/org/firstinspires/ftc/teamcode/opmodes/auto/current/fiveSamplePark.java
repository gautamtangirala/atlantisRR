...
@Autonomous (name = "Five Sample With Park", preselectTeleOp = "atlantisTele")
public class fiveSamplePark extends atlantisAutoEssentials {
...
// Variables to track last button press times
        ...
        while (opModeInInit()) {
            ...
            telemetry.addLine("5 SAMPLE AUTO W PARK: 83 POINTS");
