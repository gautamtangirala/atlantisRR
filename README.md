# SparkFun  Quickstart for Roadrunner 1.0

The SparkFun  or Optical Tracking Odometry Sensor is an optical-based odometry sensor with an integrated IMU.
...
The  sensor is designed to ONLY work on official field tiles.
...
The custom localization is implemented using the SparkFunDrive class, which *extends* MecanumDrive.
This means that all of RoadRunner's standard tuning should remain in MecanumDrive, but you should use SparkFunDrive
in your OpModes.
...
making a post in roadrunner-help on the FTC Discord with your MecanumDrive and SparkFunDrive attached and pinging me
(@j5155).
...
Also, make sure to configure the  in your hardware config. 
By default, SparkFunDrive will look for a sensor named sensor_,
but you can change this in SparkFunDrive line 70.
